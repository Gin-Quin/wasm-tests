(module
  ...
  (func (;13;) (type 0)
    ...
    i32.add
    i32.store)
  (func (;14;) (type 2) (param i32 i32 i32 i32) (result i32)
    (local i32 i32 i32)
    block (result i32)  ;; label = @1
      loop  ;; label = @2
        local.get 2
    ...
    local.get 2
    i32.ge_u)
  (func (;15;) (type 2) (param i32 i32 i32 i32) (result i32)
    local.get 2
  ...
  (func (;52;) (type 8) (param i32 i32 i32 i32)
    ...
    i32.sub
    i32.store)
  (func (;53;) (type 7) (param i64) (result i64)
    (local i64)
  ...
  (func (;60;) (type 0)
    ...
    i32.add
    i32.store)
  (func (;61;) (type 7) (param i64) (result i64)
    (local i64)
    local.get 0
    call 53
    local.set 1
  ...
  (export "free" (func 55))
  (export "calloc" (func 56))
  (export "realloc" (func 57))
  (export "_start" (func 58))
  (export "resume" (func 59))
  (export "go_scheduler" (func 60))
  (export "fib" (func 61))
  (export "asyncify_start_unwind" (func 62))
  (export "asyncify_stop_unwind" (func 63))
  (export "asyncify_start_rewind" (func 64))
  (export "asyncify_stop_rewind" (func 65))
  (export "asyncify_get_state" (func 66))
  (elem (;0;) (i32.const 1) func 27 30 14 15)
  (data (;0;) (i32.const 65536) "stack overflowfree: invalid pointer\00\00\00\00\00\0e\00\01\00\15\00\00\00realloc: invalid pointer0\00\01\00\18\00\00\00out of memorypanic: panic: runtime error: nil pointer dereferenceindex out of rangeslice out of rangeunreachable\b5\00\01\00\0b")
  (data (;1;) (i32.const 65736) "\c1\82\01\00\10\01\01\00\00\00\00\00\c8\01\01\00\c1\82\01\00\00\00\00\00\04\00\00\00\0c\00\00\00\01\00\00\00\00\00\00\00\03\00\00\00\00\00\00\00\04"))
